...
def init_arg_parser():
    ...
    arg_parser.add_argument('--mode', choices=['train', 'test', 'synth'], required=True, help='Run mode')
    ...
    arg_parser.add_argument('--search_order', type=str, default='dfs', help='the order of searching')
    return arg_parser
